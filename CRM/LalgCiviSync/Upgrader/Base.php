 ...
 */
class CRM_LalgCiviSync_Upgrader_Base {

  /**
   * @var CRM_LalgCiviSync_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_LalgCiviSync_Upgrader(
        'lalg-civi-sync',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_LalgCiviSync_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_LalgCiviSync_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
